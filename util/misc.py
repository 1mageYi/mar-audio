...
def load_model(args, model_without_ddp, optimizer, loss_scaler, ema_params):
    """
    从检查点加载模型状态，用于恢复训练。
    (已更新以处理 PyTorch 2.6+ 的 torch.load 安全策略)
    """
    if args.resume:
